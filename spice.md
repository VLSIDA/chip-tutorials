...
You should install the PDK using ciel which you can install with Python pip.
For example,
...
```
~/.ciel/sky130A/libs.ref/sky130_fd_sc_hd/cdl/sky130_fd_sc_hd.cdl
```
